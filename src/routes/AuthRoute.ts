...
import { loginUser, resendMobileOTP, resendEmailOTP, sendVerificationEmail, verifyOTP, getAuthVerificationStatus, createUserDetails, suggestUsername, createUserPassword } from "../controllers/auth/AuthController";
