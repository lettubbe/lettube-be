...
router.get("/:playlistId", protect_1.protect, PlaylistController_1.getPlaylist);
router.delete("/:playlistId", protect_1.protect, PlaylistController_1.deletePlaylist);
router.get("/:userId/public", protect_1.protect, PlaylistController_1.getUserPublicPlaylists);
