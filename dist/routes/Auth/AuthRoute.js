...
const resetPasswordValidationSchema_1 = __importStar(require("../../middleware/validation/authentication/resetPasswordValidationSchema"));
...
router.post("/verify/resend", AuthController_1.resendOTP);
...
router.post("/resetPassword", (0, resetPasswordValidationSchema_1.default)(resetPasswordValidationSchema_1.passwordResetSchema), AuthController_1.resetPassword);
