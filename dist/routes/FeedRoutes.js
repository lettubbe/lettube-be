...
const feedUploadValidationSchema_1 = __importStar(require("../middleware/validation/feeds/feedUploadValidationSchema"));
...
router.post("/upload", [protect_1.protect, multer_1.default.fields([{ name: "thumbnailImage" }, { name: "postVideo" }])], (0, feedUploadValidationSchema_1.default)(feedUploadValidationSchema_1.validatePostFeedSchema), FeedController_1.uploadFeedPost);
